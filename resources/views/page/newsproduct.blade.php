                            ...
                            <div id="tg-content" class="tg-content">
                                <div class="tg-products">
                                        ...
                                        <div class="tg-refinesearch">
                                            <span>
                                                ...
                                                @if (request('priceFilter') == 1)
                                                    {{ $newestProductsCount }} sản phẩm (Dưới 100.000 VNĐ)
                                                @elseif (request('priceFilter') == 2)
                                                    {{ $newestProductsCount }} sản phẩm (Trên 100.000 VNĐ)
                                                @else
                                                    {{ $newestProductsCount }} sản phẩm (Tất cả)
                                                @endif
                                            </span>
                                    ...
                                    <div class="pagination justify-content-center">
                                        {{ $newestProducts->appends(['priceFilter' => request('priceFilter')])->links('pagination::bootstrap-4') }}
                                    </div>
                                </div>
                            </div>
                        </div>
