                                ...
                                <div class="tg-products">
                                    <div class="tg-productgrid">
                                        <div class="tg-refinesearch">
                                            <span>Hiển thị 1 đến 16 sản phẩm của
                                                @if (request('priceFilter') == 1)
                                                    {{ $promotionalProductsCount }} sản phẩm (Dưới 100.000 VNĐ)
                                                @elseif (request('priceFilter') == 2)
                                                    {{ $promotionalProductsCount }} sản phẩm (Trên 100.000 VNĐ)
                                                @else
                                                    {{ $promotionalProductsCount }} sản phẩm (Tất cả)
                                                @endif
                                            </span>
                                            ...
                                            <div class="col-xs-6 col-sm-6 col-md-4 col-lg-3" style="height: 600px;">
                                                <div class="tg-postbook">
                                                    ...
                                                    <div class="tg-postbookcontent">
                                                        ...
                                                        @if (isset($attributes[$product->id]['Đánh giá']))
                                                            @for ($i = 1; $i <= 5; $i++)
                                                                @if ($i <= $attributes[$product->id]['Đánh giá'])
                                    ...
                                    <div class="pagination justify-content-center">
                                        {{ $promotionalProducts->links('pagination::bootstrap-4') }}
                                    </div>
                                </div>
                            </div>
                        </div>
