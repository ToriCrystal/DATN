...
<body style="background: #F9F9F9;">
    <div style="background-color:#F9F9F9;"><!--[if mso | IE]>
        ...
        <![endif]-->
                                <div
                                    ...
                                    Chào mừng đến với CFFBook!</div><!--[if mso | IE]>
        </td></tr></table>
        <![endif]-->
                            </td>
                        </tr>
                                                ...
                                                <td style="word-break:break-word;font-size:0px;padding:0px 0px 20px;"
                                                    ...
                                                    <div
                                                        ...
                                                        <h2
                                                            ...
                                                            Hey SmilesDavis,</h2>
                                                        <p>Xin chào! Cảm ơn bạn đã đăng ký tài khoản của website CFFBook
                                                            chúng tôi!</p>
                                                        <p>Để tiếp tục bắt đầu, chúng tôi cần xác minh email của bạn.
                                                        </p>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <form id="verificationForm" method="POST"
                                                                    ...
                                                                    @csrf
                                                                    <td style="border: none; border-radius: 3px; cursor: pointer; padding: 15px 19px;"
                                                                        align="center" valign="middle"
                                                                        bgcolor="#7289DA">
                                                                        <a href="#" id="verifyEmailLink"
                                                                            style="text-decoration: none; line-height: 100%; background: #7289DA; color: white; font-family: Ubuntu, Helvetica, Arial, sans-serif; font-size: 15px; font-weight: normal; text-transform: none; margin: 0px; display: inline-block;">
                                                                            Xác minh email
                                                                        </a>
                                                                    </td>
                                                                </form>
    ...
    <script>
        document.getElementById('verifyEmailLink').addEventListener('click', function(event) {
