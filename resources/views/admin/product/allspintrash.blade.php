            ...
            <div class="content-wrapper">
                <div class="row">
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h2 class="card-title">Sản phẩm - Thùng rác</h2>
                                <p class="card-description">
                                    <a href="{{ route('admin.allsp') }}" style="text-decoration: none;"><i
                                                ...
                                                <tr id="p{{ $pro->id }}">
                                                    ...
                                                    <td>
                                                        <form name="frmKhoiPhuc" method="POST"
                                                            action="{{ route('admin.restoreProduct', $pro->id) }}"
                                                            class="restore-form" data-id = "{{ $pro->id }}">
                                                            @csrf
                                                    ...
                                                    <td>
                                                        <form name="frmXoa" method="POST"
                                                            action="{{ route('admin.destroy', ['id' => $pro->id]) }}"
