            ...
            <div class="content-wrapper">
                <div class="row">
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h2 class="card-title">Tác giả - Thùng rác</h2>
                                <p class="card-description">
                                    <a href="{{ route('admin.alltg') }}" style="text-decoration: none;"><i
                                        ...
                                        <tbody>
                                            @foreach ($author as $item)
                                                <tr id="p{{ $item->id }}">
                                                    ...
                                                    <td>
                                                        {{ trim(substr($item->author_name, 0, 10)) }}
                                                    </td>
                                                    <td>
                                                        {{ $item->deleted_at }}
                                                    </td>
                                                    <td>
                                                        <form name="frmKhoiPhuc" method="POST"
                                                            action="{{ route('admin.restoretg', $item->id) }}"
                                                    ...
                                                    <td>
                                                        <form name="frmXoa" method="POST"
                                                            action="{{ route('admin.destroytg', ['id' => $item->id]) }}"
