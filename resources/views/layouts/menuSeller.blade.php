...
<div class="dlabnav">
    <div class="dlabnav-scroll">
        <ul class="metismenu" id="menu">
            <li><a class="has-arrow " href="{{ route('seller.index') }}" aria-expanded="false">
            ...
            <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                    ...
                    <span class="nav-text">Ứng dụng</span>
                </a>
                <ul aria-expanded="false">
                    ...
                    <li><a class="has-arrow" href="{{ route('seller.product.product') }}" aria-expanded="false">Sản phẩm</a>
                        <ul aria-expanded="false">
                            <li><a href="{{ route('seller.product.product') }}">Sản phẩm</a></li>
                            <li><a href="{{ route('seller.product.productAdd') }}">Thêm sản phẩm</a></li>
                            <li><a href="ecom-checkout.html">Thùng rác</a></li>
                        </ul>
                    </li>
                    <li><a href="ecom-product-order.html">Đơn hàng</a></li>
                    <li><a href="ecom-checkout.html">Thanh toán</a></li>
                    <li><a href="ecom-invoice.html">Hóa đơn</a></li>
                    <li><a href="ecom-customers.html">Khách hàng</a></li>
        ...
        <div class="side-bar-profile">
            <div class="d-flex align-items-center justify-content-between mb-3">
                <div class="side-bar-profile-img">
                    <img src="/images/seller/user.jpg" alt="">
                </div>
